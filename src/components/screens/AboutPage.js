    ...
    <div className='about-page'>
        ...
        <div className="about jumbotron">
            ...
            <hr className="my-3"></hr>
                ...
                - Daily summary mail - Email will be send at 4 pm every day - email will contains information about all blog post from one day<br></br>
                - Weekly summary mail - Email will be send at 4 pm at Sunday - email will contains information about all blog post from one week<br></br>
        </div>
    </div>
    )
}
